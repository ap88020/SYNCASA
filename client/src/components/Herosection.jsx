...
import { ArrowRight, Home, Video } from "lucide-react"; // lucide-react icons

const Herosection = () => {
  return (
    <div>
      {/* Hero Section */}
      <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px -16 lg:px-24 xl:px-40 text-black mx-auto max-w-6xl bg-white">
        ...
        <div className="flex items-center gap-4 mb-7">
          {/* React Router Link with ArrowRight icon */}
          <Link
            to="/get-started"
